...
*===================================*/
  ...
  function init() {
    ...
    var mapOptions = {
      ...
      center: new google.maps.LatLng(40.702, -73.922), // New York
    ...
    var marker = new google.maps.Marker({
      position: new google.maps.LatLng(40.702, -73.922),
      map: map,
...
function sendmail() {
  ...
  Email.send({
    SecureToken: 'b631133f-c83c-49ea-8d45-9e5714452712',
    To: 'noor.alam.619@gmail.com',
    From: Sender,
    Subject: 'New Subscriber',
    Body: 'You have new subscriber : ' + Sender,
  }).then((message) => {
    if (message == 'OK') {
